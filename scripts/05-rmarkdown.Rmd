...
<b>texto marcado</b> **texto marcado**
...
A seguir, [apresentamos]{.ul} uma lista dos principais marcadores utilizados para formatar texto:
...
```{r, fig.align = "center", warning = FALSE, fig.cap="Figura 1. Nota média ao longo dos anos.", out.width="50%"}
imdb %>% 
  group_by(ano) %>% 
